...
public class ComZhuCeFrame extends JInternalFrame {
	...
	public ComZhuCeFrame() {
		...
		namejlabel.setText("number:");			//设置标签文本
		...
		String[] array=new String[]{"visitor","membership"};//卡的类型列表
		...
		caridjlabel.setText("platenumber:");			//设置标签文本
		...
		savejbutton.setText("register");//设置按钮文本
