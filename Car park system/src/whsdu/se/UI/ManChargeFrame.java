...
public class ManChargeFrame extends JInternalFrame {
	...
	public  ManChargeFrame() {
		...
		Panel1.add(new JLabel("membership:"));				//添加到面板1
		Panel1.add(new JLabel());//添加面板1

		JLabel bigjlabel1 = new JLabel();	
		bigjlabel1.setText("large lot($/h)");		
		...
		smalljlabel1.setText("small lot($/h):");		
		...
		bigjlabel2.setText("large lot($/h):");			
		...
		smalljlabel2.setText("small lot($/h):");		
		...
		savejbutton.setText("edit");//设置按钮文本
	...
	class  gaiActionListener implements ActionListener {			// 添加修改按钮的事件监听器
		public void actionPerformed(final ActionEvent e) {
			...
			Dal.gaicharge("update charger set charge ="+ a1+" where cardtype = 'membership'and stationtype = 'large lot'");
			Dal.gaicharge("update charger set charge ="+ a2+" where cardtype = 'membership'and stationtype = 'small lot'");
			Dal.gaicharge("update charger set charge ="+ a3+" where cardtype = 'visitor'and stationtype = 'large lot'");
			Dal.gaicharge("update charger set charge ="+ a4+" where cardtype = 'visitor'and stationtype = 'small lot'");
