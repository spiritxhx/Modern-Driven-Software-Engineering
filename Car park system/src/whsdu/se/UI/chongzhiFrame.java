...
public class chongzhiFrame extends JInternalFrame {
	...
	public chongzhiFrame() {
		...
		JLabel passwordjlabel = new JLabel();	//创建charge标签
		passwordjlabel.setText("charge:");			//设置标签文本
	...
	class addmanActionListener implements ActionListener {			// 添加charge按钮的事件监听器
		public void actionPerformed(final ActionEvent e) {
			int a2 = Integer.parseInt(passwordjtextfield.getText());
			int a3 = a4 +a2;
			Dal.chongzhi("update users set overage ="+ a3+" where cardid = " + a1 );
			JOptionPane.showMessageDialog(null, "charge success！");
		}
	}
