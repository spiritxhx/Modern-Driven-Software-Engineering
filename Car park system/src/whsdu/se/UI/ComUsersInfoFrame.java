...
public class ComUsersInfoFrame extends JInternalFrame {
	...
	public ComUsersInfoFrame() {
		...
		cardtypejlabel.setText("type:");			//设置标签文本
	...
	class queryActionListener implements ActionListener {			// 添加find按钮的事件监听器
