/*
 * 该ui类用于实现车辆管理菜单下的vehicles out菜单项
 * */
package whsdu.se.UI;
...
public class ParkOutFrame extends JInternalFrame {
	private JTextField cardidjtextfield;//创建card number文本框
	private JTextField stationidtextfield;//创建姓名文本框
	private JLabel sumparkjtextfield ;//创建card number文本框
	private JLabel feejtextfield ;//创建card number文本框
	private users user;
	...
	public ParkOutFrame() {
		...
		enjbutton.setText("out lot confirmation");//设置按钮文本
	...
	class xiaofeiActionListener implements ActionListener {			// 添加credit card的事件监听器
		public void actionPerformed(final ActionEvent e) {
			//第一步:得到单价 = a6
