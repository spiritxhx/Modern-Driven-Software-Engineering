...
public class LoginFrame extends JFrame {
	...
	public LoginFrame() {
		...
		setTitle("parking lot management");							//设置窗体标题
		...
		userNamelabel.setText("login name:");						//设置标签文本
		...
		passwordLabel.setText("password:");							//设置标签文本
	...
	class LoginAction implements ActionListener {//实现登陆按钮的监听
		public void actionPerformed(final ActionEvent e) {
			...
			if(user.getName()!=null) {
				...
				JOptionPane.showMessageDialog(null,"Please enter the correct user name and password");//弹出提示框
				username.setText("");//设置用户名输入框为空
				password.setText("");//设置密码输入框为空
			}
		}
